            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap relative">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 relative">
                      ...
                      <div className="flex ml-6 items-center">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="rounded border appearance-none border-gray-300 py-2 focus:outline-none ${color === 'white' ? 'border-black' : 'border-gray-300' focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-base pl-3 pr-10"
                          >
                ...
                <div className="flex">
                  ...
                  <button
                    className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-3 sm:px-6 focus:outline-none hover:bg-orange-600 rounded font-firasans font-medium"
                    onClick={() => {
                ...
                <div className="buyNow flex justify-center items-center my-3 md:justify-start">
                  ...
                  >
                    <HiOutlineShoppingCart className="text-xl rotate-12 text-orange-100 font-bold" />
                    <span>Buy Now</span>
                  </button>
                </div>
                <div className="pin mt-6 flex space-x-2 text-base">
                  ...
                  />
                  <button
                    className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-3 sm:px-6 focus:outline-none ${color === 'white' ? 'border-black' : 'border-gray-300' hover:bg-orange-600 rounded font-firasans font-medium"
