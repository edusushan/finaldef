...
const AddVariants = () => {
  ...
  const onProductChange = (e) => {
    ...
    // console.log(e.target.value, product[0]);
  };
  ...
  const handleSubmit = (e) => {
    ...
    // }
    // console.log(file);
    dispatch(addVariant({ formdata, toast, productId }));
    setData({
      title: "",
      desc: "",
      product: {},
        ...
        <div className="maindiv text-black pt-0.5 mx-2 lg:mx-10">
          ...
          >
            <div className="productDescriptionContainer grid grid-cols-12 gap-10">
              <div className="productDescriptionLeft col-span-12 lg:col-span-8 shadow-lg shadow-gray-600/30 border bg-white h-[500px] py-4 px-4 w-[95vw] md:w-full">
                <div className="formGroup my-2">
                  <label htmlFor="product" className="label text-lg">
                    Select Product:-
                  </label>
                  <select
            ...
            <div className="buttonDiv flex justify-start h-16 mb-10">
              <button
                className="py-2 px-10 bg-orange-500 text-white font-firasans rounded-sm hover:bg-orange-700 shadow-lg shadow-gray-600/60 my-2"
                type="subimt"
              >
                Add Variant
              </button>
