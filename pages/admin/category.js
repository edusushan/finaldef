    ...
    <>
      ...
      >
        <div className="categories mx-10">
          ...
          <button
            className="text-xl bg-orange-700 my-4 font-ubuntu text-white py-2 px-4 rounded-sm cursor-pointer"
          ...
          <div className="categoryTable overflow-x-auto  mb-3">
            {categories.length !== 0 ? (
              ...
              <div
                className="text-3xl text-center font-ubuntu text-orange-700 cursor-pointer"
                onClick={() => setShowModal(true)}
              >
                + Add new Category
              </div>
