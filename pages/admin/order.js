              ...
              <div className="editOrder text-xl font-firasans">
                ...
                {orderDelivery !== "Delivered" ? (
                  <>
                    ...
                    <button
                      className={`py-2 px-10 ml-6 rounded-sm bg-orange-500 text-white hover:bg-orange-700 shadow-md shadow-gray-500 ${
                        order.status === "Pending" &&
                        "shadow-none bg-orange-300 hover:bg-orange-300 cursor-not-allowed"
                      }`}
