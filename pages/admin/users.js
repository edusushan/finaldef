        ...
        <div className={`maindiv text-black pt-0 mt-10 `}>
          <div className="usersTable py-10">
            <div className="container w-[96%] sm:w-[90%] mx-auto">
              <h1 className="font-roboto text-2xl text-center my-6 text-orange-700">
                All Users
              </h1>
                  ...
                  <div className="modalBody">
                    <form>
                      <div className="inputGroup mx-4 my-2">
                        ...
                        <select
                          className="w-full border-2 rounded-md my-1 border-orange-500 outline-blue-600 py-2 px-4"
                          type="text"
                          name="name"
                          id="name"
                          value={admin}
                          ...
                          >
                            ...
                            <td className="py-4 px-6 flex justify-center items-center">
                              {item.gender !== "" ? (
                                ...
                                // <div className="h-10 rounded-full text-lg flex items-center justify-center bg-orange-600 text-white w-10 border">
                                //   {getFirstLetter(item.name)}
                                // </div>
                                <div
                                  className={`h-10 rounded-full text-lg flex items-center justify-center bg-orange-600 text-white w-10 border`}
                                >
                                  {getFirstLetter(item.name)}
                                </div>
                              )}
