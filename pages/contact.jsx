...
function Contact() {
  return (
    <div className="bg-gray-50">
      <div className="flex banner justify-center py-10 lg:py-20 bg-indigo-100 w-full bg-cover bg-no-repeat bg-bottom ">
        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 ">
            <div className="border p-10 rounded-lg text-center">
              <span className="flex justify-center text-4xl text-violet-500 mb-4 ">
                <svg
              ...
              <p className="mb-0 text-base opacity-90 leading-7">
                <a href="mailto:sastobazar@gmail.com" class="text-violet-500">
                  sastobazar@gmail.com
                </a>
                Contact us today for friendly and reliable service using our
                email!
              </p>
            </div>
            <div class="border p-10 rounded-lg text-center">
              <span class="flex justify-center text-4xl text-violet-500 mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p class="mb-0 text-base opacity-90 leading-7">
                <a href="telephone:+977-986*******" class="text-violet-500">
                  +977-986*******
                </a>
                Have a question or need assistance? Reach out to us via phone!
              </p>
            </div>
            <div class="border p-10 rounded-lg text-center">
              <span class="flex justify-center text-4xl text-violet-500 mb-4">
              ...
              <p class="mb-0 text-base opacity-90 leading-7">
                <a href="mailto:" class="text-violet-500"></a> MadanBhandari
                Road , Bijuli Bazar, Kathmandu Nepal
              </p>
            </div>
          </div>
              ...
              <form className="w-full mx-auto flex flex-col justify-center">
                <div className="mb-12">
                  ...
                  <p className="text-base opacity-90 leading-7">
                    we prioritize seamless communication and effortless customer
                    service. Whether you have a question about an order, need
                    assistance with product information, or simply want to share
                    feedback, below form is your gateway to personalized
                    assistance.
                  </p>
                </div>
                <div className="flex flex-col space-y-5">
                    ...
                    <div className="w-full md:w-1/2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          class="py-2 px-4 md:px-5 w-full appearance-none border text-sm opacity-75 text-input rounded-md placeholder-body min-h-12 transition duration-200 focus:ring-0 ease-in-out bg-white border-gray-200 focus:outline-none focus:border-violet-500 h-11 md:h-12"
                        ></input>
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    <button
                      data-variant="flat"
                      class="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none bg-violet-500 text-white px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 hover:text-white hover:bg-violet-600 h-12 mt-1 text-sm lg:text-base w-full sm:w-auto"
                    >
                      Send Message
                    </button>
                  </div>
