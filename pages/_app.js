...
function MyApp({ Component, pageProps }) {
  ...
  const addToCart = (itemCode, qty, price, name, size, variant, img, title) => {
    let newCart = cart;
  ...
  const buyNow = (itemCode, qty, price, name, size, variant, img, title) => {
    let newCart = {};
    newCart[itemCode] = { qty: 1, price, name, size, variant, img, title };
    setCart(newCart);
    saveCart(newCart);
