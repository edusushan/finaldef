      ...
      <footer className="text-gray-600 body-font bg-orange-50 ">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p className="mt-2 px-4 text-sm text-orange-500">
              Indulge Your Senses with Our Collection: From Cozy Cloth Books to
              Stylish Hoodies and Mugs,
            </p>
            <p className="px-4 text-sm text-orange-500">
              Find Your Perfect Match. Embrace Comfort, Style, and Inspiration
              in Every Purchase!
            </p>
          </div>
